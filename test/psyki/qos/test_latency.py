...
class TestLatencyOnIris(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.model = create_uneducated_predictor(self.dataset.shape[1]-1, 3, [60], "relu", "softmax")
    ...
    def test_latency_fit(self):
        ...
        set_seed(0)
        latency = evaluate_metric(self.model, self.educated, self.dataset, Latency.compute_during_training)
