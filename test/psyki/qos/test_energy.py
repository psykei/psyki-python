...
class TestEnergyOnIris(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.uneducated = create_uneducated_predictor(self.dataset.shape[1] - 1, 3, [60], "relu", "softmax")
    ...
    def test_energy_fit_with_kins(self):
        ...
        energy = evaluate_metric(self.uneducated, educated_predictor, self.dataset, Energy.compute_during_training)
...
class TestEnergyOnSplice(unittest.TestCase):
    ...
    def test_energy_fit_with_kins(self):
        ...
        energy = evaluate_metric(self.uneducated, educated, self.dataset, Energy.compute_during_training)
        self.assertTrue(isinstance(energy, float))
