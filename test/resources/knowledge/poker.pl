...
straight(S1,R1,S2,R2,S3,R3,S4,R4,S5,R5) :- min5(R1,R2,R3,R4,R5,R), (R1 + R2 + R3 + R4 + R5) = ((5 * R) + 10), \+ pair(S1,R1,S2,R2,S3,R3,S4,R4,S5,R5).

royal(S1,R1,S2,R2,S3,R3,S4,R4,S5,R5) :- min5(R1,R2,R3,R4,R5,R), R = 1, ((R1 + R2 + R3 + R4 + R5) = 47), \+ pair(S1,R1,S2,R2,S3,R3,S4,R4,S5,R5).
