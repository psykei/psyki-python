...
class EnergyQoS:
    ...
    def test_measure(self, fit: bool = False):
        if fit:
            ...
            print('The injected model is {:.5f} kWh {} energy consuming during training'.format(
        ...
        print(
            'Calculating energy spent for model prediction. This may take a while depending on the model and dataset...')
        energy_test = []
        ...
        # First model should be the bare model, Second one should be the injected one
        print('The injected model is {:.5f} kWh {} energy consuming during inference'.format(
        ...
        print(
            'The injected model life-cycle is {} energy consuming. The total energy consumption metrics is equal to {}.'.format(
